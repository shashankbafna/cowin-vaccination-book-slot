...
class telegram_chatbot():
    ...
    def subscribe_To_Telegram(self):
        ...
        r=re.compile("(t.me\/[A-Za-z0-9]*)|(^[0-9]+:[A-Za-z0-9_-]*$)")
        print("\n###### Steps to subscribe ######\n")
        ...
        print("4) Feel free to ping @shashankbafna on telegram if any help is required in setup.")
        ...
        msg=self.recieveFromBot(timeout=300,subsCap=f"Subscribe {captchSub}")
        if "Done! Congratulations on your new bot. You will find it at t.me" not in msg:
            r=re.compile("[0-9]{9}:[a-zA-Z0-9_-]{35}")
        self.botname,self.token=(filter(r.match,msg.split()))
        ...
        self.send_message(f'\n*Your profile config updated. Good to proceed with steps for startup.*',chat_id=self.selfid,parse_mode='markdown')
        print("Subscribing...")
