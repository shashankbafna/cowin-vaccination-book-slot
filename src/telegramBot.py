...
class telegram_chatbot():
    ...
    def subscribe_To_Telegram(self):
        ...
        while (self.selfid is None or len(self.selfid) < 1):
            print(f"Please type in the app 'Subscribe <ID>' .")
            print(f"3) Send this 6 digit code to @CowinAuto: Subscribe {captchSub}")
            self.subscribeBot(timeout=300,isFirst=True,subsCap=f"Subscribe {captchSub}")
        ...
        while (self.botname is None or len(self.botname) < 1 or self.botname == 'CowinAutoBot'):
        ...
        if updates:
            if "result" in updates:
                ...
                for item in updates:
                    ...
                    if subsCap in message and isFirst:
